...
- **소문자 변환**: "Great"와 "great"을 동일하게 처리
...
- **훈련 데이터**: 긍정적 리뷰와 부정적 리뷰를 균형 있게 학습 데이터로 구성.
...
모델은 대부분 긍정적 리뷰를 정확하게 분류했으나, 일부 부정적 리뷰에서 오분류가 발생했습니다. 이는 리뷰의 내용이 다소 모호하거나 문장이 길어져서 발생한 문제일 수 있습니다.
...
이렇게 Markdown 형식으로 작성된 보고서를 GitHub에 올리시면 됩니다. 파일명을 `README.md`로 저장하시고, GitHub 리포지토리에 업로드하시면 됩니다!
